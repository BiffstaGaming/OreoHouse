...
// Profile modal: display name + avatar only. Theme picker used to
// live here too but has moved to the Preferences modal so per-machine
// UX settings (theme + sounds + notifications) all stack in one
// place, mirroring the web client.
